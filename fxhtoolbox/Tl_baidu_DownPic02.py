...
def Tl_baidu_DownPic02(keyword,pic_number):
   word = keyword
   ...
   for url in urls:
    #    print("正在请求：", url)
       html = requests.get(url, timeout=10).content.decode('utf-8')  # 变量html 保留了一份Json文件,其中 objURL 是 图片对应在网址
    #    print("正在请求：", html)
...
def call_DownPic02_main(keyword,pic_number):
#    print("欢迎使用百度图片下载脚本！\n目前仅支持单个关键词。")
#    print("下载结果保存在脚本目录下的results文件夹中。")
#    print("=" * 50)
#    word = input("请输入你要下载的图片关键词：\n")
    # Tl_baidu_DownPic02('Raspberry',50)    
    Tl_baidu_DownPic02(keyword,pic_number)    
